...
loaded_model = pickle.load(open(r'C:/Users/agnis/Desktop/Workspace/DEV/MACHINE LEARNING PROJECTS/DISEASE DETECTION MODELS/Heart Disease Prediction/trained_model.sav', 'rb'))
